...
export const PatientTable = ({ patients }: PatientTableProps) => {
  const [selectedPatient, setSelectedPatient] = useState<PatientSideAdminPage>()
  ...
  const getGenderBadge = (gender: string) => {
    ...
    const className =
      genderConfig[gender?.toLowerCase() as keyof typeof genderConfig] || "bg-gray-100 text-gray-800 border-gray-200"
  ...
  const getStatusBadge = (status: string) => {
    ...
    const className =
      statusConfig[status?.toLowerCase() as keyof typeof statusConfig] || "bg-gray-100 text-gray-800 border-gray-200"
  ...
  return (
    <div className="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
      ...
      <div className="bg-gradient-to-r from-green-50 to-emerald-50 p-8 border-b border-gray-100">
        <div className="flex items-center justify-between gap-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="text-2xl font-bold text-gray-900">Quản lý bệnh nhân</h3>
              <p className="text-sm text-gray-600 mt-1">Tổng cộng {patients.length} bệnh nhân</p>
            </div>
          </div>
          ...
          <thead className="bg-gray-50 sticky top-0">
            <tr>
              {[
                ...
                <th key={h} className="px-6 py-4 text-left text-xs font-bold text-gray-600 uppercase tracking-wider">
                  {h}
                </th>
              ))}
            </tr>
              ...
              >
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-2 mt-1">
                        {getGenderBadge(patient.patient.profile?.gender || "Chưa xác định")}
                      </div>
                    </div>
                  </div>
                </td>
                <td className="px-6 py-5">
                  <div className="space-y-1">
                    <div className="text-sm font-medium text-gray-900">{patient.emailContact}</div>
                    <div className="text-sm text-gray-600">{patient.phoneContact}</div>
                  </div>
                </td>
                <td className="px-6 py-5">
                ...
                <td className="px-6 py-5">
                  <div className="space-y-1">
                    <div className="text-sm text-gray-900">{patient.patient.partnerEmail || "Chưa có"}</div>
                    <div className="text-sm text-gray-600">{patient.patient.partnerPhone || "Chưa có"}</div>
                  </div>
                </td>
                <td className="px-6 py-5">
                  <div className="max-w-xs">
                    <p className="text-sm text-gray-700 truncate" title={patient.patient.medicalHistory}>
                      {patient.patient.medicalHistory || "Không có tiền sử bệnh"}
                    </p>
                  </div>
                </td>
                <td className="px-6 py-5">
      ...
      {/* ===== Detail Section ===== */}
      {selectedPatient && (
        <div className="bg-gradient-to-br from-gray-50 to-green-50/30 border-t border-gray-100">
          ...
          <div className="p-8 border-b border-gray-100">
            <div className="flex items-start gap-6">
              <div className="relative">
                <div className="w-24 h-24 bg-gradient-to-br from-green-400 to-emerald-500 rounded-full flex items-center justify-center text-white font-bold text-2xl shadow-lg border-4 border-white">
                  <img src={selectedPatient.patient.profile?.avatarUrl} alt="" className="rounded-full"/>
                </div>
                ...
                <div className="flex items-start justify-between">
                  <div>
                    ...
                    <div className="flex items-center gap-4 mb-3">
                      {getGenderBadge(selectedPatient.patient.profile?.gender || "Chưa xác định")}
                    ...
                    <div className="flex items-center gap-6 text-sm text-gray-600">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="font-semibold text-gray-900">
                          {selectedPatient.patient.profile?.dateOfBirth || "Chưa cập nhật"}
                        </span>
                      </div>
                      <div className="flex items-center gap-2">
                        <span className="font-medium">Tổng đơn điều trị:</span>
                        <span className="font-bold text-green-600">{selectedPatient.orders?.length || 0}</span>
                      </div>
                    </div>
                  </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
              <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
                ...
                <div className="space-y-2">
                  <div className="flex items-center gap-2 text-sm">
                    ...
                    <span className="font-medium text-gray-900">{selectedPatient.emailContact}</span>
                  </div>
                  <div className="flex items-center gap-2 text-sm">
                    <span className="text-gray-600">Điện thoại:</span>
                    <span className="font-medium text-gray-900">{selectedPatient.phoneContact}</span>
                  </div>
                  <div className="flex items-start gap-2 text-sm">
                    <span className="text-gray-600">Địa chỉ:</span>
                    <span className="font-medium text-gray-900">
                      {selectedPatient.patient.profile?.address || "Chưa cập nhật"}
                    </span>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
                <h5 className="font-semibold text-gray-900 mb-3">Người thân</h5>
                <div className="space-y-2">
                  <div className="flex items-center gap-2 text-sm">
                    <span className="text-gray-600">Họ tên:</span>
                    <span className="font-medium text-gray-900">
                      {selectedPatient.patient.partnerFullName || "Chưa có thông tin"}
                    </span>
                  </div>
                  <div className="flex items-center gap-2 text-sm">
                    <span className="text-gray-600">Email:</span>
              ...
              <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
                <h5 className="font-semibold text-gray-900 mb-3">Tiền sử bệnh</h5>
                <p className="text-sm text-gray-700 leading-relaxed">
                  {selectedPatient.patient.medicalHistory || "Không có tiền sử bệnh đặc biệt"}
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="p-8">
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                <h5 className="text-xl font-bold text-gray-900">Lịch sử điều trị</h5>
                <p className="text-sm text-gray-600">Tổng cộng {selectedPatient.orders?.length || 0} đơn điều trị</p>
              </div>
            </div>
                      ...
                      >
                        ...
                        <td className="px-6 py-4">
                          <div className="text-sm">
                            <div className="font-medium text-gray-900">{o.startDate}</div>
                            <div className="text-gray-600">đến {o.endDate}</div>
                          </div>
                        </td>
